package devel.some.memories.widget
...
import devel.some.memories.MainActivity
import devel.some.memories.navigation.ACTION_CREATE_ECHO
                    ...
                    modifier = GlanceModifier
                        .clickable {
                            val intent = Intent(context, MainActivity::class.java).also {
                                it.data = "https://memoriesinvoice.com/echos/true".toUri()
